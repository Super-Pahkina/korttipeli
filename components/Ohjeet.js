    ...
    return (
        <View style={styles.kontti}>
            <ScrollView style={styles.scrollView}>
                ...
                <CollapsibleView title={<Text style={styles.otsikko}>Pelin kulku lyhyesti</Text>} style={styles.collapsibleView}>
                ...
                <CollapsibleView title={<Text style={styles.otsikko}>Pelin asetukset</Text>} style={styles.collapsibleView}>
                    <Text style={styles.teksti}>{'\n'}Gamerules-sivulla voit määritellä seuravat asetukset:{'\n'}</Text>
                    <CollapsibleView title={<Text style={styles.alaotsikko}>Ajan asetus</Text>} style={styles.collapsibleView}>
                        <Text style={styles.teksti}>{'\n'}Voit määrittää vuorosi keston painamalla '-' tai '+' -painiketta 'Vuoroaika (5-60)' kohdalla.{'\n'}
                        </Text>
                    </CollapsibleView>

                    <CollapsibleView title={<Text style={styles.alaotsikko}>Voittopisteiden asetus</Text>} style={styles.collapsibleView}>
                    ...
                    <CollapsibleView title={<Text style={styles.alaotsikko}>Kategorian asetus</Text>} style={styles.collapsibleView}>

                        <Text style={styles.teksti}>{'\n'}Voit valita yhden seuraavista elintarvikekategorioista:{'\n'}</Text>

                        <CollapsibleView title={<Text style={styles.alaotsikko2}>Liha</Text>} style={styles.collapsibleView}>
                            <Text style={styles.teksti}>Liha-, kala-, ja kanatuotteet</Text>
                        </CollapsibleView>
                        <CollapsibleView title={<Text style={styles.alaotsikko2}>Hedelmät</Text>} style={styles.collapsibleView}>
                            <Text style={styles.teksti}>Hedelmät ja marjat</Text>
                        </CollapsibleView>
                        <CollapsibleView title={<Text style={styles.alaotsikko2}>Vihannekset</Text>} style={styles.collapsibleView}>
                            <Text style={styles.teksti}>Juurekset, kasvikset ja sienet</Text>
                        </CollapsibleView>
                        <CollapsibleView title={<Text style={styles.alaotsikko2}>Maitotuotteet</Text>} style={styles.collapsibleView}>
                            <Text style={styles.teksti}>Maidot, juustot, jogurtit, jäätelöt</Text>
                        </CollapsibleView>
                        <CollapsibleView title={<Text style={styles.alaotsikko2}>Viljatuotteet</Text>} style={styles.collapsibleView}>
                            <Text style={styles.teksti}>Pastat, riisit, ohrat, kaurat, vehnät, rukiit</Text>
                        </CollapsibleView>
                        <CollapsibleView title={<Text style={styles.alaotsikko2}>Juomat</Text>} style={styles.collapsibleView}>
                            <Text style={styles.teksti}>Maitojuomat, kasvisjuomat, kahvit ja teet, virvoitusjuomat</Text>
                        </CollapsibleView>
                        <CollapsibleView title={<Text style={styles.alaotsikko2}>Makeat</Text>} style={styles.collapsibleView}>
                        ...
                        <CollapsibleView title={<Text style={styles.alaotsikko2}>Kolesteroliton</Text>} style={styles.collapsibleView}>
                            <Text style={styles.teksti}>
                        ...
                        <CollapsibleView title={<Text style={styles.alaotsikko2}>Gluteeniton</Text>} style={styles.collapsibleView}>
                            <Text style={styles.teksti}>
                        ...
                        <CollapsibleView title={<Text style={styles.alaotsikko2}>Runsaskuituinen</Text>} style={styles.collapsibleView}>
                            <Text style={styles.teksti}>
                        ...
                        <CollapsibleView title={<Text style={styles.alaotsikko2}>Laktoositon</Text>} style={styles.collapsibleView}>
                            <Text style={styles.teksti}>
                        ...
                        <CollapsibleView title={<Text style={styles.alaotsikko2}>Lakto-ovovegetaarinen</Text>} style={styles.collapsibleView}>
                            <Text style={styles.teksti}>
                                {'\n'}Lakto-ovo-vegetaariseen ruokavalioon sisältyy kasvikunnan tuotteiden lisäksi maitovalmisteita ja kananmunaa.{'\n'}</Text>
                        </CollapsibleView>
                        <CollapsibleView title={<Text style={styles.alaotsikko2}>Vähärasvainen</Text>} style={styles.collapsibleView}>
                            <Text style={styles.teksti}>
                        ...
                        <CollapsibleView title={<Text style={styles.alaotsikko2}>Vegaaninen</Text>} style={styles.collapsibleView}>
                            <Text style={styles.teksti}>
                ...
                <CollapsibleView title={<Text style={styles.otsikko}>Erikoiskortit</Text>} style={styles.collapsibleView}>
                    <CollapsibleView title={<Text style={styles.alaotsikko}>Timanttikortti</Text>} style={styles.collapsibleView}>
                        <Text style={styles.teksti}>
                    ...
                    <CollapsibleView title={<Text style={styles.alaotsikko}>Lumihiutalekortti</Text>} style={styles.collapsibleView}>
                        <Text style={styles.teksti}>
                ...
                <CollapsibleView title={<Text style={styles.otsikko}>Pelaaminen</Text>} style={styles.collapsibleView}>
                    <CollapsibleView title={<Text style={styles.alaotsikko}>Pakan valinta</Text>} style={styles.collapsibleView}>
                        <Text style={styles.teksti}>
                    ...
                    <CollapsibleView title={<Text style={styles.alaotsikko}>Käyttäjän vuoro</Text>} style={styles.collapsibleView}>
                        <Text style={styles.teksti}>
                    ...
                    <CollapsibleView title={<Text style={styles.alaotsikko}>Kierroksen tulos</Text>} style={styles.collapsibleView}>
                        <Text style={styles.teksti}>
                    ...
                    <CollapsibleView title={<Text style={styles.alaotsikko}>Vastustajan vuoro</Text>} style={styles.collapsibleView}>
                        <Text style={styles.teksti}>
